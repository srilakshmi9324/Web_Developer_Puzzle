...
import { getReadingList, removeFromReadingList,toggleMarkedAsRead,
  undoToggledMarkedAsRead } from '@tmo/books/data-access';
...
export class ReadingListComponent {
  ...
  toggleMarkedAsRead(item: ReadingListItem) {
